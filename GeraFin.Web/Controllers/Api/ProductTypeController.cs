...
namespace GeraFin.Controllers.Api
{
    ...
    public class ProductTypeController : Controller
    {
        ...
        [HttpPost("[action]")]
        public IActionResult Insert([FromBody]Crud<ProductType> payload)
        {
        ...
        [HttpPost("[action]")]
        public IActionResult Update([FromBody]Crud<ProductType> payload)
        {
            ProductType productType = payload.value;
        ...
        [HttpPost("[action]")]
        public IActionResult Remove([FromBody]Crud<ProductType> payload)
        {
