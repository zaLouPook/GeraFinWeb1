...
namespace GeraFin.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var model = new Models.ViewModels.Manage.Index
            {
                TotalTasks = 0,
                DailyIssuesCount = 0,
                DailyIncomeCount = 0,
        ...
        public async Task<IActionResult> SendVerificationEmail(Models.ViewModels.Manage.Index model)
        {
        ...
        public IActionResult ShowRecoveryCodes()
        {
            ...
            var model = new ShowRecoveryCodes { RecoveryCodes = recoveryCodes };
            return View(model);
        }
        ...
        public async Task<IActionResult> GenerateRecoveryCodes()
        {
            ...
            var model = new ShowRecoveryCodes { RecoveryCodes = recoveryCodes.ToArray() };
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("GeraFin"),
                _urlEncoder.Encode(email),
                unformattedKey);
        }

        private async Task LoadSharedKeyAndQrCodeUriAsync(ApplicationUser user, EnableAuthenticator model)
        {
